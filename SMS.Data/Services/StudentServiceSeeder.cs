...
namespace SMS.Data.Services
{
    public static class StudentServiceSeeder
    {
        public static void Seed(IStudentService svc)
        {
            ...
            var s1 = svc.AddStudent("Homer", "homer@mail.com", "Computing", 44, "https://miro.medium.com/max/1400/1*uCk-IDvDtDjFgoCy0vLkPw.png", 45.0);
            var s2 = svc.AddStudent("Marge", "marge@mail.com", "Engineering", 40, null, 68.0);
